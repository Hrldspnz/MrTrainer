...
incioConversacionAux(Lista,[]):-incioConversacion(Lista,[]),write("Ha pensado en entrenar algun deporte?"),deporteSolicitadoAux().
incioConversacionAux(Lista,[]):-write("Saludo no detectado").
...
deporteSolicitadoAux():-  nl, read_string(user_input, '\n', '.', _, Str),atomic_list_concat(Lista, ' ', Str),seleccion(Lista,[]).
seleccion(Lista,Vacio,Deporte):-afirmacion(Lista,Vacio),write('Puede escoger entre correr,ciclismo,natacion'),opcionesDeporte(Deporte),write(Deporte).
seleccion(Lista,Vacio,Deporte):-afirmacion(Lista,Resto),deporte(Resto,Vacio),atomics_to_string(Resto,Deporte),write(Deporte).  
...
nivelarCliente(Nivel):- write('Cuantas veces a la semana hace ejercicio: '), read(Cantidad), buscarNivel(Nivel,Cantidad).
...
padecimiento('problemas de espalda').
...
%Natacion
rutina('Rutina 1','natacion', padecimientos,'principiante',4,'
	Domingo: Descanso\n
	...
	').
rutina('Rutina 2','natacion', padecimientos,'principiante intenso',5,'
	Domingo: Descanso.\n
...
').
rutina('Rutina 3','natacion', padecimientos,'intermedio',4,'
	...
	Sábado: Descanso.
').
rutina('Rutina 4','natacion', padecimientos,'intermedio intenso',5,'
	...
	Sábado: Descanso.\n
	').
rutina('Rutina 5','natacion', padecimientos,'avanzado',4,'
...
%Correr
rutina('Preparación para 5 Kilómetros','correr', padecimientos, 'principiante', 4,
       ...
       '). 
rutina('Inicial','correr', padecimientos, 'principiante intenso', 3,
       ...
       '). 
rutina('Mejora tu forma','correr', padecimientos, 'intermedio', 4,
       'Día 1: Día de descanso.\n
       Día 2: 25 minutos de carrera a ritmo fácil. 5 a 10 minutos de enfriamiento. Estiramientos.\n
       Día 3: 10 minutos de calentamiento. 5 minutos de carrera a ritmo de serie. 2 minutos de trote de recuperación. Repetir 4 veces. 5 a 10 minutos de enfriamiento. Estiramientos.\n
       Día 4: 30 minutos de carrera a ritmo fácil. 5 a 10 minutos de enfriamiento. Estiramientos.\n
       ...
       Día 7: 30 minutos de entrenamiento cruzado.\n
       ') . 
rutina('Preparación Medio maratón','correr', padecimientos, 'avanzado', 4,
       'Día 1: Día de descanso.\n
       ...
       ') . 
rutina('Preparación 10k','correr', padecimientos, 'intermedio intenso', 4,
       'Día 1: Día de descanso.\n
       Día 2: 25 minutos de carrera a ritmo fácil. 5 a 10 minutos de enfriamiento. Estiramientos.\n
       Día 3: 10 minutos de calentamiento. 5 minutos de carrera a ritmo de serie. 2 minutos de trote de recuperación. Repetir 4 veces. 5 a 10 minutos de enfriamiento. Estiramientos.\n
       Día 4: 30 minutos de carrera a ritmo fácil. 5 a 10 minutos de enfriamiento. Estiramientos.\n
...
%Ciclismo
rutina('Preparación 100k','ciclismo', padecimientos, 'principiante', 3,
       ...
       Domingo:- Descanso\n
       '). 
rutina('Recorrido 100k','ciclismo', padecimientos, 'principiante intenso', 3,
       ...
       Domingo: - Descanso\n
       ').
rutina('Mantener desarrollo para 100k','ciclismo', padecimientos, 'intermedio', 4,
       'Lunes: - Sesión de entrenamiento de 2 horas- Haz un calentamiento sencillo.- Monta en la zona 2.- Pedalea durante 5 minutos. Este entrenamiento se puede hacer en bicicleta o en un entrenamiento cruzado, como senderismo.\n
       Martes: - Descanso\n
       ...
       Domingo: - Descanso\n
       '). 
rutina('Preparación para 120k o más','ciclismo', padecimientos, 'intermedio intenso', 4,
       ...
       Domingo: - Descanso
       '). 
rutina('Mantener desarrollo para 120km o más','ciclismo', padecimientos, 'Avanzado', 4,
       'Lunes: - Descanso\n
